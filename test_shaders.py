...
def cross_compile(shader, vulkan, spirv, invalid_spirv, eliminate, is_legacy, flatten_ubo, flatten_dim):
    spirv_f, spirv_path = tempfile.mkstemp()
...
def test_shader(stats, shader, update, keep):
    ...
    spirv, glsl, vulkan_glsl = cross_compile(joined_path, vulkan, is_spirv, invalid_spirv, eliminate, is_legacy, flatten_ubo, flatten_dim)
